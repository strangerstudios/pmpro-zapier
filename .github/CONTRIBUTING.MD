# Contribute to Paid Memberships Pro - Zapier Add On

Paid Memberships Pro - Zapier Add On is the "community solution" for connecting Paid Memberships Pro to Zapier, and so contributions of all kinds are appreciated.
...
* Submit a ticket for your issue, assuming one does not already exist.
  * Raise it on our [Issue Tracker](https://github.com/strangerstudios/pmpro-zapier/issues/new/)
...
* Make sure to pull in any "upstream" changes first.
	* Use `git remote add upstream https://github.com/strangerstudios/pmpro-zapier.git` to set the upstream repo
...
* Finally, please use tabs and not spaces. The tab indent size should be 4 for all Paid Memberships Pro - Zapier Add On code.
